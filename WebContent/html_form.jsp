...
<body>
	<fieldset style="width:500px;">
		...
		<!-- form表单的action属性规定当表单提交时，向何处发送表单数据，method属性指明表单的提交方式，分为get和post，默认为get -->
		<form action="${pageContext.request.contextPath}/RequestDemo03" method="post">
			<!-- 输入文本框，SIZE表示显示长度，maxLength表示最多输入长度 -->
			编&nbsp;&nbsp;号(文本框)：
			<input type="text" name="userid" value="NO." size="10" maxlength="10"><br>
			...
			<!-- 复选框，可以同时选中多个选项，名称必须一样，其中value为真正需要的内容 -->
			兴&nbsp;&nbsp;趣(复选框)：
			...
			<!-- 大文本输入框，宽度为34列，高度为5行 -->
			说&nbsp;&nbsp;明(文本域)：
			<textarea name="note" rows="5" cols="34"></textarea><br>
